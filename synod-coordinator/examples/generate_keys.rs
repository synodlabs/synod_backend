...
fn main() {
    ...
    println!("SYNOD_STELLAR__COORDINATOR_PUBKEY={}", encode_stellar_address(0x30, &public_key));
    println!("SYNOD_STELLAR__COORDINATOR_SECRET_KEY={}", encode_stellar_address(0x40, &seed));
    println!("");
}
