...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-synod-accent/10 via-synod-bg to-synod-bg">
      {/* Decorative Elements */}
      <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-synod-accent/5 blur-[120px] rounded-full" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[30%] h-[30%] bg-synod-error/5 blur-[100px] rounded-full" />
      ...
      <div className="w-full max-w-md z-10">
        <div className="text-center mb-10 space-y-2">
          <div className="inline-flex p-4 bg-synod-accent/10 rounded-2xl border border-synod-accent/20 mb-4 animate-glow">
            <Shield className="text-synod-accent w-10 h-10" />
          </div>
          <h1 className="text-4xl font-black tracking-tight text-white uppercase">
            Synod<span className="text-synod-accent">_</span>Core
          </h1>
          <p className="text-muted-foreground font-medium">Secure Governance & Treasury Coordination</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                ...
                <button type="button" className="text-[10px] text-synod-accent font-bold hover:underline">Forgot?</button>
              </div>
              <Input
                type="password"
                placeholder="••••••••"
        ...
        <p className="mt-8 text-center text-[10px] text-muted-foreground font-mono uppercase tracking-[0.2em]">
          Powered by Stellar Consensus Protocol
        </p>
      </div>
    </div>
  )
